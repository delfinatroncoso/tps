...
function preload() {
  ...
  for ( let i = 0; i < 4; i++ ) {
    immariposas[i] = loadImage( "data/mariposa" + i + ".png" );
  }
...
//-----------JUEGO-------------
//CARGAR PNG MARIPOSAS
//HACER QUE SE MUEVAN TIPO LOGO DVD
//CREAR COLISIONES, SI TOCO EL PNG CON EL MOUSE ENTONCES CONTADOR SUMA +1
//VER COMO HACER EL RELOJ
